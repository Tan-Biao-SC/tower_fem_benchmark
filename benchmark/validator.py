"""Validator: compare computed results against reference data."""
...
def validate_frequencies(
    ...
    Returns True if all frequencies match within relative tolerance.
    """
...
def validate_tip_disp(
    ...
    """Compare cantilever tip displacement files (6 load cases × 6 DOF)."""
