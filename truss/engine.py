"""Template engine for finite-length truss APDL inputs."""
...
class TemplateEngine:
    """Loads, concatenates, and substitutes APDL templates."""
    ...
    def substitute(content: str, case: CaseDefinition) -> str:
        ...
        reps = {
            ...
            "__NUM_PLOT_MODES_VAL__": (
                ...
                if case.num_plot_modes is not None
                else "10"
            ),
        }
        result = content
    ...
    def build(self, case: CaseDefinition) -> str:
        """Full pipeline: concatenate and substitute."""
